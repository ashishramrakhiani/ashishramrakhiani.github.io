...
<html>
	<head>
		<title>Taste Buds, Simplified!</title>
		<meta charset="utf-8" />
							...
							<section id="two" class="spotlights">								
								<section>
									<a href="generic.html" class="image">
										<img src="http://www.tatasalt.com/images/products/tata_salt/img_tata_salt.png" alt="" data-position="top center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
												<h3>Tata Salt (with Sprinkler)</h3>
											</header>
											<p>The pioneer of salt iodisation in India, <strong>Tata Salt</strong>,<br>holds the distinction of being India's first national branded<br> <strong>iodised salt</strong>.<br>It has been consistently recognised as<br>one of the country's leading food brands.<br><br>

											Launched in 1983, Tata Salt provided an assurance of purity<br>in a market where unbranded salt of dubious quality was the norm.<br> Using Vacuum® Evaporation technology, Tata Salt offered consumers<br> a <strong>healthy, hygienic</strong> alternative<br> — an iodised vacuum evaporated salt that was<br> untouched by hand.</p>
											<ul class="actions">
												<li><a href="#two" class="button">1kg @ ₹25</a></li>
									...
									{
										$sql1="select * from product where pname like 'Salt%'";

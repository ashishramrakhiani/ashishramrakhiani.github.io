							...
							<section id="two" class="spotlights">								
								<section>
									<a href="generic.html" class="image">
										<img src="https://p2.zopnow.com/images/products/320/more-superior-cardamom-elaichi-green-v-50-g.png" alt="" data-position="25% 25%" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
												<h3>More Superior Cardamom</h3>
											</header>											
											<ul class="actions">
												<li><a href="" class="button">50g @ ₹143</a></li>
									...
									{
										$sql1="select * from product where pname like '%Cardamom'";
